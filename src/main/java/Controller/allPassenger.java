...
@WebServlet("/viewAllPassenger")
public class allPassenger extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<PassengerModel> passengers = passengerModel.viewAllPassengers();
        ...
        if(passengers.size() != 0){
            ...
            out.write("{\"size\": "+ passengers.size() +",\"list\":"+ centerJson+"}");
