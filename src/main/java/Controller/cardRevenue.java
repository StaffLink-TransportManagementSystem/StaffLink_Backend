...
@WebServlet("/cardRevenue")
public class cardRevenue extends HttpServlet{
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<PassengerPaymentsModel> passengerPaymentsList = passengerPaymentsModel.getCardRevenue(fromDate, toDate);
