...
@WebServlet("/RevenueOwner")

public class RevenueOwner extends HttpServlet{
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Gson gson = new Gson();
        PassengerPaymentsModel ownerRevenue = gson.fromJson(requestBody.toString(), PassengerPaymentsModel.class);
        String ownerEmail = ownerRevenue.getOwnerEmail();
        String fromDate = ownerRevenue.getFromDate();
        String toDate = ownerRevenue.getToDate();
        System.out.println("email : " + ownerEmail);
        System.out.println("from date : " + fromDate);
        System.out.println("to date : " + toDate);

        PassengerPaymentsModel passengerPaymentsModel = new PassengerPaymentsModel();
        List<PassengerPaymentsModel> passengerPaymentsList = passengerPaymentsModel.ownerRevenue(ownerEmail, fromDate, toDate);
