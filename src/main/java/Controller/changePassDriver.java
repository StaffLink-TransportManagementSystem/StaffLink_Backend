...
@WebServlet("/changePassDriver")
public class changePassDriver extends HttpServlet{
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("Inside changePassDriver");
        ...
        Gson gson = new Gson();
        DriverModel changePass = gson.fromJson(requestBody.toString(), DriverModel.class);
