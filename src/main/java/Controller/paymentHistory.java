...
public class paymentHistory extends HttpServlet{
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String passengerEmail = revenueReport.getPassengerEmail();
        ...
        List<PassengerPaymentsModel> passengerPaymentsList = passengerPaymentsModel.paymentHistory(passengerEmail, fromDate, toDate);
