...
@WebServlet("/getDriverNotification")
public class GetDriverNotification extends HttpServlet {
...
//         Get all cookies from the request
        ...
        try {
            ...
            List<NotificationModel> notification = NotificationModel.getDriverNotification(Email);
