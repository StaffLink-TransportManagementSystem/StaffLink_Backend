...
public class DeleteNotification extends HttpServlet{
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        try {
            ...
            NotificationModel deleteNotification = gson.fromJson(bufferedReader, NotificationModel.class);

            NotificationDAO NotificationDAO = new NotificationDAO();
            if(NotificationDAO.deleteNotification(String.valueOf(deleteNotification.getNotificationId()))){
