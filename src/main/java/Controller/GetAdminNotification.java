...
@WebServlet("/getAdminNotification")
public class GetAdminNotification extends HttpServlet {
...
//         Get all cookies from the request
        ...
        try {
            ...
            List<NotificationModel> notification = NotificationModel.getAdminNotification(Email);
