...
public class createPassengerServelet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        try {
            ...
            String NIC = passenger.getNIC();
            String address = passenger.getAddress();
            String contactNo = passenger.getContactNo();
            String homeLocation = passenger.getHomeLocation();
            String workLocation = passenger.getWorkLocation();
            String type = passenger.getType();
//            String onTime = passenger.getOnTime();
//            String offTime = passenger.getOffTime();
//            String upAndDown = passenger.getUpAndDown();
...
//            }
            ...
            if(passenger.createPassenger()){
                ...
                out.write("\"email\": \""+ passenger.getEmail()+ "\",");
                out.write("\"phone\": \""+ passenger.getName() +"\"}");
